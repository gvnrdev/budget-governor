...
const PAYTO = '0xC7E3d38A1ba1A5498d533285a96298FEbade1B38';
...
describe('Slot 5 brand surface', () => {
  it('mcp.json card name is "Gvnr" and version 1.5.1', async () => {
  ...
  it('openapi.json title is "Gvnr" and version 1.5.1', async () => {
    ...
    expect(body.info.version).toBe('1.5.1');
