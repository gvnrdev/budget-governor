...
<body>
  <div class="container">
    ...
    <section>
      ...
      <p><strong>Billing for direct B2B adoption:</strong> SEPA EUR invoicing is arranged manually by email &mdash; mail <a href="mailto:admin@gvnr.dev">admin@gvnr.dev</a> with expected monthly volume and a billing contact, and you receive an invoice payable into a Luxembourg IBAN (Avvio rail). There is no productized invoice flow today. For self-serve, the same substrate is reachable via the x402 USDC packs on the <a href="/">homepage</a>.</p>
    </section>
    ...
    <section>
      ...
      <div class="contact-block">
        ...
        <p><a href="https://github.com/gvnrdev/gvnr/issues" target="_blank" rel="noopener">github.com/gvnrdev/gvnr/issues</a></p>
      </div>
    </section>
    ...
    <footer>
      <div class="footer-row">
        ...
        <span>·</span>
        <a href="https://github.com/gvnrdev/gvnr" target="_blank" rel="noopener">GitHub</a>
        <span>·</span>
